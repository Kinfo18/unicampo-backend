...
export class UsersController {
  ...
  async uploadAvatar(
    ...
    return this.usersService.updateAvatar(user.sub, `/uploads/avatars/${file.filename}`);
  }

  /** ADMIN: lista paginada con búsqueda */
  @Get()
  ...
  findAll(
    ...
    return this.usersService.findAll(Number(page), Number(limit), search, role, active);
  }

  /** ADMIN: actualizar rol o estado de un usuario */
  @Patch(':id')
  @UseGuards(RolesGuard)
  @Roles(Role.ADMIN)
